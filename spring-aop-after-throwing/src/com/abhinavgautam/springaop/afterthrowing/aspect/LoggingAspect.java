...
public class LoggingAspect {
	...
	@Before("com.abhinavgautam.springaop.afterthrowing.aspect.PointcutExpressions.forDaoPackage()")
	...
	@AfterReturning(pointcut = "execution(* com.abhinavgautam.springaop.afterthrowing.dao.AccountDAO.findAccount(..))", returning = "result")
	...
	@AfterThrowing(pointcut = "execution(* com.abhinavgautam.springaop.afterthrowing.dao.AccountDAO.findAccount(..))", throwing = "exception")
